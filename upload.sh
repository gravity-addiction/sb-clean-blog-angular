#!/bin/sh
/usr/bin/rsync -avz --delete --progress --exclude "node_modules" -e "ssh -i ~/.ssh/strictdev2_macbook.pem" ./dist/sb-clean-blog-angular/ ec2-user@aws-2.strictdev.com:/usr/local/www/apache24/data/skydiveorbust.com/html/
